...
const ChatBot = () => {
  ...
  const updateDraftCountAndNotify = async () => {
    try {
      const response = await fetch(
        "https://juristo-backend-test.vercel.app/api/users/updated",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchQuestions = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch(
        "https://juristo-backend-test.vercel.app/api/legaldocs/questions",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  const handleGenerate = async (answersToGenerate) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://juristo-backend-test.vercel.app/api/legaldocs/generate",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
