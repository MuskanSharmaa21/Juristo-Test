  ...
  useEffect(() => {
    const fetchChats = async () => {
      const data = await fetch(
        `https://juristo-backend-test.vercel.app/api/image-chat/${user.userId}`
        // `https://juristo-backend-test.vercel.app/api/image-chat/${user.userId}`
      ).then((res) => res.json());
  ...
  const deleteChat = async (chatId) => {
    ...
    try {
      const response = await fetch(
        `https://juristo-backend-test.vercel.app/api/image-chat/${chatId}`,
        {
          // const response = await fetch(`https://juristo-backend-test.vercel.app/api/image-chat/${chatId}`, {
          method: "DELETE",
        }
      );
