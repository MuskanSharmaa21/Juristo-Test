  ...
  const handleCountryChange = async (selectedOption) => {
    ...
    try {
      const response = await fetch(
        `https://juristo-backend-test.vercel.app/api/users/update/${user.userId}`,
        {
          // const response = await fetch(`https://juristo-backend-test.vercel.app/api/users/update/${user.userId}`, {
          method: "PUT",
          headers: {
